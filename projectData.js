export default [
  {
    ...
    image: "/assets/Facebook-clone.PNG",
    link: "https://social-network-clone.vercel.app/",
    github: "https://github.com/codeOfTheFuture/facebook_clone",
    about: {
      projectDesc: "Project description: ",
      projectDescText:
        "Clone of Facebook. This is a clone of the Facebook website feed. I created this project to strengthen my skills with the react javascript library as well as learn the tailwindcss library.",
      techStack: "Tech Stack: ",
      techStackList:
        "React | React-router | TailwindCSS | Firebase firestore | Firebase storage | Firebase auth",
      bulletPoints: [
  ...
  },
  {
    ...
    image: "/assets/Google-clone.PNG",
    link: "https://google-clone-vert-one.vercel.app/",
    github: "https://github.com/codeOfTheFuture/google-clone",
    about: {
      projectDesc: "Project description: ",
      projectDescText:
        "Clone of Google. This is a clone of the Google search page. I created this project to strengthen my skills with the react javascript library as well as server side rendering with the react framework Next.js.",
      techStack: "Tech Stack: ",
      techStackList: "Next.js | React.js | TailwindCSS | Firebase auth",
      bulletPoints: [
        "Contributed primarily on the react front-end along with some back-end contributions integrating the firebase admin SDK.",
        "Built candlestick chart using Canvas Js to display data from a data science PostgreSQL database.",
        "Collaborated with a team of 5 web developers and 3 data scientists to complete the project within a 6-week deadline.",
