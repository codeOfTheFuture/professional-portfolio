...
const InfoLeftColumn = ({ profilePic }: Props) => {
	...
	return (
		<div className={styles.infoLeftColumn}>
			<img id={styles.profilePic} src={urlFor(profilePic).url()} alt="Picture of Jeff Oliver" />
			...
			<div id={styles.themeOptionsWrapper}>
				<div
					...
					onClick={() => selectTheme("lightMode")}
				></div>

				<div
					id={styles.blueMode}
					className={currentTheme}
					onClick={() => selectTheme("blueMode")}
				></div>
				<div
					id={styles.greenMode}
					className={currentTheme}
					onClick={() => selectTheme("greenMode")}
				></div>
				<div
					id={styles.purpleMode}
					className={currentTheme}
					onClick={() => selectTheme("purpleMode")}
				></div>
			</div>
